...
import me.trashout.api.request.ApiGetEventDetailRequest;
...
public class GetEventDetailService extends BaseService {

    private static List<ApiBaseRequest> mRequestList = new ArrayList<>();

    public static void startForRequest(Context context, int requestId, long eventId) {
        ApiGetEventDetailRequest apiGetEventDetailRequest = new ApiGetEventDetailRequest(requestId, eventId);
        addRequest(context, GetEventDetailService.class, apiGetEventDetailRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiGetEventDetailRequest apiGetEventDetailRequest = (ApiGetEventDetailRequest) apiBaseRequest;


        Call<Event> call = mApiServer.getEventDetail(apiGetEventDetailRequest.getEventId());
        call.enqueue(new Callback<Event>() {
            ...
            public void onResponse(Call<Event> call, Response<Event> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    result = new ApiGetEventDetailResult(response.body());
                } else {
            ...
            @Override
            public void onFailure(Call<Event> call, Throwable retrofitError) {
