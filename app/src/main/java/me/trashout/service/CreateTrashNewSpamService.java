...
import me.trashout.api.request.ApiCreateTrashNewSpamRequest;
...
public class CreateTrashNewSpamService extends BaseService {

    private static List<ApiBaseRequest> mRequestList = new ArrayList<>();

    public static void startForRequest(Context context, int requestId, long trashPointActivityId, long userId) {
        ApiCreateTrashNewSpamRequest apiCreateTrashNewSpamRequest = new ApiCreateTrashNewSpamRequest(requestId, new ApiCreateTrashNewSpamParam(trashPointActivityId,userId));
        addRequest(context, CreateTrashNewSpamService.class, apiCreateTrashNewSpamRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiCreateTrashNewSpamRequest apiCreateTrashNewSpamRequest = (ApiCreateTrashNewSpamRequest) apiBaseRequest;


        Call<ResponseBody> call = mApiServer.createTrashNewSpam(apiCreateTrashNewSpamRequest.getApiCreateTrashNewSpamParam());
