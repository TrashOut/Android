...
import me.trashout.api.request.ApiJoinUserToEventRequest;
...
public class JoinUserToEventService extends BaseService {

    private static List<ApiBaseRequest> mRequestList = new ArrayList<>();

    public static void startForRequest(Context context, int requestId, long eventId, List<Long> users) {
        ApiJoinUserToEventRequest apiJoinUserToEventRequest = new ApiJoinUserToEventRequest(requestId, eventId, new ApiJoinUserToEventParam(users));
        addRequest(context, JoinUserToEventService.class, apiJoinUserToEventRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiJoinUserToEventRequest apiJoinUserToEventRequest = (ApiJoinUserToEventRequest) apiBaseRequest;


        Call<ResponseBody> call = mApiServer.joinUserToEvent(apiJoinUserToEventRequest.getEventId(), apiJoinUserToEventRequest.getApiJoinUserToEventParam());
