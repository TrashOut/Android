...
import me.trashout.api.request.ApiCreateCollectionPointNewSpamRequest;
...
public class CreateCollectionPointNewSpamService extends BaseService {

    private static List<ApiBaseRequest> mRequestList = new ArrayList<>();

    public static void startForRequest(Context context, int requestId, long collectionPointActivityId) {
        ApiCreateCollectionPointNewSpamRequest apiCreateCollectionPointNewSpamRequest = new ApiCreateCollectionPointNewSpamRequest(requestId, new ApiCreateCollectionPointNewSpamParam(collectionPointActivityId));
        addRequest(context, CreateCollectionPointNewSpamService.class, apiCreateCollectionPointNewSpamRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiCreateCollectionPointNewSpamRequest apiCreateCollectionPointNewSpamRequest = (ApiCreateCollectionPointNewSpamRequest) apiBaseRequest;


        Call<ResponseBody> call = mApiServer.createCollectionPointNewSpam(apiCreateCollectionPointNewSpamRequest.getApiCreateCollectionPointNewSpamParam());
