...
import me.trashout.api.request.ApiGetNewsDetailRequest;
...
public class GetNewsDetailService extends BaseService {

    private static List<ApiBaseRequest> mRequestList = new ArrayList<>();

    public static void startForRequest(Context context, int requestId, long newsId) {
        ApiGetNewsDetailRequest apiBaseRequest = new ApiGetNewsDetailRequest(requestId, newsId);
        addRequest(context, GetNewsDetailService.class, apiBaseRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiGetNewsDetailRequest apiGetNewsDetailRequest = (ApiGetNewsDetailRequest) apiBaseRequest;


        Call<NewsDetail> call = mApiServer.getNewsDetail(apiGetNewsDetailRequest.getNewsId());
        call.enqueue(new Callback<NewsDetail>() {
            ...
            public void onResponse(Call<NewsDetail> call, Response<NewsDetail> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    result = new ApiGetNewsDetailResult(response.body());
                } else {
            ...
            @Override
            public void onFailure(Call<NewsDetail> call, Throwable retrofitError) {
