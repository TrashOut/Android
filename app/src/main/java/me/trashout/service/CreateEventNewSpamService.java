...
import me.trashout.api.request.ApiCreateEventNewSpamRequest;
...
public class CreateEventNewSpamService extends BaseService {

    private static List<ApiBaseRequest> mRequestList = new ArrayList<>();

    public static void startForRequest(Context context, int requestId, long eventId, long userId) {
        ApiCreateEventNewSpamRequest apiCreateEventNewSpamRequest = new ApiCreateEventNewSpamRequest(requestId, new ApiCreateEventNewSpamParam(eventId,userId));
        addRequest(context, CreateEventNewSpamService.class, apiCreateEventNewSpamRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiCreateEventNewSpamRequest apiCreateEventNewSpamRequest = (ApiCreateEventNewSpamRequest) apiBaseRequest;


        Call<ResponseBody> call = mApiServer.createEventNewSpam(apiCreateEventNewSpamRequest.getApiCreateEventNewSpamParam());
