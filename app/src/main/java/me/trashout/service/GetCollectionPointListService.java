...
public class GetCollectionPointListService extends BaseService {
    ...
    public static void startForRequest(Context context, int requestId, CollectionPointFilter collectionPointFilter, LatLng lastPosition, int page) {
        ApiGetCollectionPointListRequest apiBaseRequest = new ApiGetCollectionPointListRequest(requestId, new ApiGetCollectionPointListParam(collectionPointFilter, lastPosition, page));
        addRequest(context, GetCollectionPointListService.class, apiBaseRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiGetCollectionPointListRequest apiGetCollectionPointListRequest = (ApiGetCollectionPointListRequest) apiBaseRequest;


        Call<List<CollectionPoint>> call = mApiServer.getCollectionPointList(apiGetCollectionPointListRequest.getApiGetCollectionPointListParam().getCollectionPointListOptions());
        call.enqueue(new Callback<List<CollectionPoint>>() {
            ...
            public void onResponse(Call<List<CollectionPoint>> call, Response<List<CollectionPoint>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    result = new ApiGetCollectionPointListResult(response.body());
                } else {
            ...
            @Override
            public void onFailure(Call<List<CollectionPoint>> call, Throwable retrofitError) {
