...
public class GetAreaListService extends BaseService {
    ...
    public static void startForRequest(Context context, int requestId) {
        ApiBaseRequest apiBaseRequest = new ApiBaseRequest(requestId);
        addRequest(context, GetAreaListService.class, apiBaseRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        Call<List<Area>> call = mApiServer.getAreaList();
        call.enqueue(new Callback<List<Area>>() {
            ...
            public void onResponse(Call<List<Area>> call, Response<List<Area>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    result = new ApiGetAreaListResult(response.body());
                } else {
            ...
            @Override
            public void onFailure(Call<List<Area>> call, Throwable retrofitError) {
