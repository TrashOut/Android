...
public class CreateEventService extends BaseService {
    ...
    public static void startForRequest(Context context, int requestId, Event event) {
        ApiCreateEventRequest apiCreateEventRequest = new ApiCreateEventRequest(requestId, event);
        addRequest(context, CreateEventService.class, apiCreateEventRequest, mRequestList);
    }
    ...
    protected void requestProcess(final ApiBaseRequest apiBaseRequest) {
        ...
        ApiCreateEventRequest apiCreateEventRequest = (ApiCreateEventRequest) apiBaseRequest;


        Call<ResponseBody> call = mApiServer.createEvent(apiCreateEventRequest.getEvent());
