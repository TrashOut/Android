...
public class ApiCreateCollectionPointNewSpamRequest extends ApiBaseRequest {
    ...
    public ApiCreateCollectionPointNewSpamRequest(int id, ApiCreateCollectionPointNewSpamParam apiCreateCollectionPointNewSpamParam) {
        super(id);
    ...
    public ApiCreateCollectionPointNewSpamParam getApiCreateCollectionPointNewSpamParam() {
        return apiCreateCollectionPointNewSpamParam;
    }
}
